...
import com.algaworks.osworks.domain.model.repository.OrdemServicoRepository;
...
public class OrdemServicoController {
	...
	private OrdemServico toEntity(OrdemServicoInput input) {
		return mapper.map(input, OrdemServico.class);
	}
}
